...
public class MultiImageSelector {
    ...
    private boolean mSingleClip = false;
    ...
    public MultiImageSelector singleClip(boolean singleClip) {
        mSingleClip = singleClip;
        return sSelector;
    }
    ...
    private Intent createIntent(Context context) {
        ...
        intent.putExtra(MultiImageSelectorActivity.EXTRA_SINGLE_CLIP, mSingleClip);
